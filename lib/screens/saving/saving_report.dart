...
import 'package:fuko_app/core/saving_report.dart';
...
class SavingReport extends StatefulWidget {
  const SavingReport({Key? key}) : super(key: key);

  @override
  State<SavingReport> createState() => _SavingReportState();
}

class _SavingReportState extends State<SavingReport> {
